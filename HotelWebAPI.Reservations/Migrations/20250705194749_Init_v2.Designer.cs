...
namespace HotelWebAPI.Main.Migrations
{
    ...
    [Migration("20250705194749_Init_v2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HotelWebAPI.Main.Entities.User", b =>
                {
                    ...
                    b.Property<decimal>("AmountOfVisits")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("HotelWebAPI.Main.Entities.UserReservation", b =>
                {
                    b.HasOne("HotelWebAPI.Main.Entities.Discount", null)
                        .WithMany("UserReservations")
                        .HasForeignKey("DiscountId");

                    b.HasOne("HotelWebAPI.Main.Entities.Room", null)
                        .WithOne("UserReservation")
                        .HasForeignKey("HotelWebAPI.Main.Entities.UserReservation", "RoomId")
